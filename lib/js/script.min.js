...
function startNewGame() {
    if (!connected) return $("#theDimmer").html('Error: Not connected!<br><a href="https://www.moneypot.com/oauth/authorize?app_id=584&response_type=token&state=Meh&redirect_uri=http://sweepabit.com">Click here to login</a>'), void $("#game_left").dimmer("show");
...
$("#bet").val(game.bet), $("#bombsButtons .button").each(function(a) {
    ...
    socket.on("connect", function() {
        ...
        socket.emit("auth", a, function(a, b) {
            ...
            }), $.getJSON("https://api.moneypot.com/v1/list-bets?access_token=" + access_token + "&app_id=584&wager=4500000&limit=11&order_by=desc", function(a) {
    ...
    var a = "https://www.moneypot.com/dialog/deposit?app_id=584",
        b = "manage-auth",
        c = "width=420,height=350,left=100,top=100",
        d = window.open(a, b, c);
    d.focus()
}), $("#withdrawButton").click(function() {
    var a = "https://www.moneypot.com/dialog/withdraw?app_id=584",
        b = "manage-auth",
        c = "width=420,height=350,left=100,top=100",
        d = window.open(a, b, c);
    d.focus()
