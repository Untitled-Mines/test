...
function startNewGame() {
    if (!connected) return $("#theDimmer").html('Error: Not connected!<br><a href="https://www.moneypot.com/oauth/authorize?app_id=1135&response_type=token&state=Meh&redirect_uri=https://untitled-mines.github.io/test">Click here to login</a>'), void $("#game_left").dimmer("show");
            ...
            if ("IN_PROGRESS" == game.status) {
                ...
                if ($(".tile").each(function(a) {
                    ...
                    console.log("next " + game.next)
                  	console.log("VALUE " + game.stake*game.next) 
                    $.ajax({
                        type: "POST",
                        contentType: "application/json",
                        ...
                        data: JSON.stringify({
                            ...
                            payouts: [{
                                from: 0,
                                to: e,
                                value: 100 * ((game.stake+2) + game.next)
                            }, {
                                from: e,
                                to: Math.pow(2, 32),
                                value: 0
                        ...
                        else console.log("BET ERROR: " + JSON.stringify(b.responseJSON)), $("#theDimmer").html("BET ERROR: " + JSON.stringify(b.responseJSON) + '<br><a href="https://www.moneypot.com/oauth/authorize?app_id=1135&response_type=token&state=Meh&redirect_uri=https://untitled-mines.github.io/test">Click here to reconnect</a>'), $("#game_left").dimmer("show"), $(".settingsButon").css("display", "inline-block")
                    })
                }
            }
        })
...
$("#bet").val(game.bet), $("#bombsButtons .button").each(function(a) {
    ...
    var a = "https://www.moneypot.com/dialog/deposit?app_id=1135",
        b = "manage-auth",
        c = "width=420,height=350,left=100,top=100",
        d = window.open(a, b, c);
    d.focus()
}), $("#withdrawButton").click(function() {
    var a = "https://www.moneypot.com/dialog/withdraw?app_id=1135",
        b = "manage-auth",
        c = "width=420,height=350,left=100,top=100",
        d = window.open(a, b, c);
    d.focus()
